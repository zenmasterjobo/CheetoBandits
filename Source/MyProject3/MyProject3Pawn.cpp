...
#include "MyProject3WheelFront.h"
...
const FName AMyProject3Pawn::LookRightBinding("LookRight");
const FName AMyProject3Pawn::EngineAudioRPM("RPM");
...
AMyProject3Pawn::AMyProject3Pawn()
{
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UMyProject3WheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UMyProject3WheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UMyProject3WheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UMyProject3WheelRear::StaticClass();
...
void AMyProject3Pawn::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	InputComponent->BindAxis("MoveForward", this, &AMyProject3Pawn::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AMyProject3Pawn::MoveRight);
	InputComponent->BindAxis(LookUpBinding);
	InputComponent->BindAxis(LookRightBinding);

	InputComponent->BindAction("Handbrake", IE_Pressed, this, &AMyProject3Pawn::OnHandbrakePressed);
	InputComponent->BindAction("Handbrake", IE_Released, this, &AMyProject3Pawn::OnHandbrakeReleased);
	InputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AMyProject3Pawn::OnToggleCamera);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AMyProject3Pawn::OnResetVR); 
}
...
void AMyProject3Pawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AMyProject3Pawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AMyProject3Pawn::EnableIncarView(const bool bState)
{
...
void AMyProject3Pawn::OnResetVR()
{
#ifdef HMD_INTGERATION
...
void AMyProject3Pawn::SetupInCarHUD()
{
...
void AMyProject3Pawn::UpdatePhysicsMaterial()
{
